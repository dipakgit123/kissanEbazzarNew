  ...
  return (
    <form className="listing-form" onSubmit={handleSubmit}>
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            <label>
              ...
              <span className="marathi">वय (वर्षांमध्ये)</span>
            </label>
            <input
              type="number"
              name="age"
          ...
          <div className="form-group">
            ...
            <div className="radio-group">
              <div className="radio-option">
                ...
                />
                <label htmlFor="horns-yes">Yes / होय</label>
              </div>
              <div className="radio-option">
                <input
                  type="radio"
                ...
                />
                <label htmlFor="horns-no">No / नाही</label>
              </div>
            </div>
          </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <div className="file-input-wrapper">
              ...
              />
              <label htmlFor="frontPhoto" className="file-input-label">
          ...
          <div className="form-group">
            ...
            <div className="file-input-wrapper">
              <input
                ...
                onChange={handleFileChange}
              />
              <label htmlFor="sidePhoto" className="file-input-label">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
          ...
          <div className="form-group">
            ...
            <div className="file-input-wrapper">
              <input
                ...
                onChange={handleFileChange}
              />
              <label htmlFor="milkScenePhoto" className="file-input-label">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
      ...
      <button type="submit" className="submit-button" disabled={loading}>
        {loading ? 'Submitting... / सबमिट करत आहे...' : 'Submit Listing / सूची सबमिट करा'}
      </button>
    </form>
  );
};
