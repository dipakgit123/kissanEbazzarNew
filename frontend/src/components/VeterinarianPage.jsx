    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E9F0F8] to-[#F0F8FF]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-2xl mx-auto mb-6">
            <div className="relative">
              ...
              <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-[#15BB73] to-[#0FA568] text-white px-6 py-2 rounded-xl font-medium hover:shadow-lg transition-all duration-300">{t("veterinarian.searchButton")}
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            ...
            >
              ...
              {Object.entries({general: "general", large_animal: "large_animal", small_animal: "small_animal", livestock: "livestock", surgery: "surgery", emergency: "emergency", reproduction: "reproduction"}).map(([value, key]) =>  (
                <option key={value} value={value}>{getSpecializationLabel(value)}</option>
              ))}
            </select>
            ...
            <select
              ...
              className="px-4 py-2 rounded-xl border border-gray-200 focus:border-[#15BB73] focus:outline-none"
            >
              <option value="10">{t("veterinarian.within10km")}</option>
              <option value="25">{t("veterinarian.within25km")}</option>
              <option value="50">{t("veterinarian.within50km")}</option>
              <option value="100">{t("veterinarian.within100km")}</option>
            </select>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center">
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                      ...
                      {service.available ? t('veterinarian.available') : t('veterinarian.notAvailable')}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div key={vet.id} className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{getSpecializationLabel(vet.specialization) || vet.specialization}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-600">
                        {vet.rating || '0'} ({vet.total_reviews || 0} {t("veterinarian.reviews")})
                      </span>
                    </div>
                    <div className="flex items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-600">{vet.experience_years}+ {t("veterinarian.yearsExperience")}</span>
                    </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      ...
                      </svg>{t("veterinarian.call")}</button>
                    <button
                      onClick={() => handleWhatsApp(vet.phone_number, vet.full_name)}
                    ...
                    >
                      ...
                      </svg>{t("veterinarian.consult")}</button>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="bg-gradient-to-r from-red-500 to-red-600 text-white p-8 rounded-2xl shadow-xl">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4">{t("veterinarian.emergencyTitle")}</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="bg-green-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
              >
