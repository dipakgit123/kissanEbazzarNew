      ...
      {showHeaderFooter && (
        <footer className="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-100 p-1 sm:p-2 flex justify-around items-center z-10">
          ...
          >
            ...
            <span className="text-xs mt-1">{t('header.pregnancy')}</span>
          </Link>
          ...
          >
            ...
            <span className="text-xs mt-1">{t('header.veterinarian')}</span>
          </Link>
          ...
          >
            ...
            <span className="text-xs mt-1">{t('header.healthCheck')}</span>
          </Link>
        </footer>
      )}
