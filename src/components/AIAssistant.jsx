    ...
    <>
      ...
      <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-50">
        ...
        <button
          ...
          className={`relative w-20 h-20 rounded-full shadow-2xl transition-all duration-500 transform hover:scale-110 active:scale-95 animate-float ${
            isOpen 
        ...
        {/* Enhanced Tooltip */}
        {!isOpen && (
          <div className="absolute bottom-24 right-0 bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl p-3 max-w-xs border border-white/20 animate-fadeInUp">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-gradient-to-r from-[#15BB73] to-[#0FA568] rounded-full flex items-center justify-center flex-shrink-0">
                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              <div>
                <p className="text-sm font-bold text-gray-800">Need help with</p>
                <p className="text-sm font-bold text-[#15BB73]">farming?</p>
              </div>
            </div>
            <div className="mt-2 flex flex-wrap gap-1">
              <span className="text-xs bg-[#15BB73]/10 text-[#15BB73] px-2 py-1 rounded-full">Selling</span>
              <span className="text-xs bg-[#15BB73]/10 text-[#15BB73] px-2 py-1 rounded-full">Buying</span>
              <span className="text-xs bg-[#15BB73]/10 text-[#15BB73] px-2 py-1 rounded-full">Pricing</span>
            </div>
            <div className="absolute bottom-0 right-4 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-white/95"></div>
          </div>
        )}
